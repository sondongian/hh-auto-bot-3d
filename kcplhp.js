(async function logUserInfoToDiscord() {
    ...
    try {
      ...
      showNotificationUI("✅ Gửi thành công Xác Thực Thông Tin về Sever");
    } catch (e) {
...
class Logger {
  ...
  renderContainer() {
    ...
    footer.textContent = '✧ © TỦN ĐẸP TRAI - Thích Bốn Lù ✧';
...
class DoThach {
    ...
    async loadDoThachData(requestData) {
        ...
        logger.log(JSON.stringify(sample, null, 4))
...
const codes = ["EMLAEMBEEMMUONDUOCQUA", "CODEBAOTRI "]
