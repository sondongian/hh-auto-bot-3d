const DOMAIN="https://hoathinh3d.team",ACTION_URL=DOMAIN+"/wp-json/hh3d/v1/action",HH3D_AJAX_URL=DOMAIN+"/wp-content/themes/halimmovies-child/hh3d-ajax.php",ADMIN_AJAX_URL=DOMAIN+"/wp-admin/admin-ajax.php";function showNotificationUI(n,t="success",e=4e3){let h="hh3d-notification-container",i=document.querySelector(`.${h}`);i||((i=document.createElement("div")).className=h,Object.assign(i.style,{position:"fixed",top:"10px",right:"10px",zIndex:9999,display:"flex",flexDirection:"column",gap:"10px",fontFamily:"Poppins, sans-serif"}),document.body.appendChild(i));let o=document.createElement("div");o.innerHTML=n,o.className="hh3d-notification",o.style.opacity="0",i.appendChild(o),requestAnimationFrame(()=>{o.style.opacity="1",o.style.transform="translateY(0)"}),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateY(-20px)",setTimeout(()=>o.remove(),500)},e)}const styleId="hh3d-notification-style";if(!document.getElementById(styleId)){let n=document.createElement("style");n.id=styleId,n.textContent=`
.hh3d-notification {
  padding: 12px 18px;
  border-radius: 12px;
  color: #fff;
