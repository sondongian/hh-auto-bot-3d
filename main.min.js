(async()=>{let n="https://hoathinh3d.cam",h=n+"/wp-json/hh3d/v1/action",t=n+"/wp-content/themes/halimmovies-child/hh3d-ajax.php",i=n+"/wp-admin/admin-ajax.php";function o(n,h="success",t=4e3){let i="hh3d-notification-container",o=document.querySelector(`.${i}`);o||((o=document.createElement("div")).className=i,Object.assign(o.style,{position:"fixed",top:"10px",right:"10px",zIndex:9999,display:"flex",flexDirection:"column",gap:"10px",fontFamily:"Poppins, sans-serif"}),document.body.appendChild(o));let g=document.createElement("div");g.textContent=n,g.style.cssText=`
        padding: 12px 16px;
        border-radius: 8px;
        font-weight: 600;
